(function () {
    ...
    */
    var text ='Manuel Marques de Sousa, Conde de Porto Alegre (Rio Grande, 13 de junho de 1804 – Rio de Janeiro, ' +
        '18 de julho de 1875), apelidado de "O Centauro de Luvas", foi um militar, político, abolicionista e monarquista brasileiro.';
    ...
    */
    ...
    var newText = text.replace(/Manuel Marques de Sousa/g, 'Marcus Carvalho');
    console.log(newText);
    ...
    */
    ...
    var newPlace = newText.replace(/brasileiro/g, 'cearense');
    ...
    */
    ...
    var noNumbers = newPlace.replace(/\d/g, '-');
    ...
    */
    ...
    var changeLetters = text.replace(/[D-Za-h]/g, '0');
    ...
    */
    ...
    var boldPhrase = text.replace(/O Centauro de Luvas/, function (phrase) {
        return phrase.toUpperCase();
    });
    console.log(boldPhrase);
