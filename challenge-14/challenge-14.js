(function () {
    ...
    */
    ...
    var name = ['mar', 'cus'];
    var pLang = name.reduce(function (acumulado, atual) {
    ...
    */
    ...
    console.log('É impossível comparar dois objetos, pois eles ocupam espaços diferentes em memória, logo, nunca serão a mesma coisa.');
